	...
	public void search()
	{
		...
		try
		{
			...
			for (int i = 0; i < ls.size(); i++)
			{
				...
				item.setText(new String[]{result[1].toString(), DatePicker.formatter.format(result[2]), result[3].toString(),
						DatePicker.formatter.format(result[4]), status, cf.format(result[6])});
