...
public class BrowserPanel extends Composite {
	...
	private void initBrowserNoControls() {
		 ...
		 * that widget if "blockNav" is set to TRUE. RSSOwl will open the selected
		 * link in a new tab or the external browser.
		 */
		browser.addLocationListener(new LocationAdapter() {
	 ...
	 * open in a new tab or the external browser. Set FALSE to allow navigation in
	 * the browser. When setting text to the browser, blockNav has to be FALSE to
	 * display the text!
	 * 
