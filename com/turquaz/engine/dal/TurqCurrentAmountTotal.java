...
public class TurqCurrentAmountTotal implements Serializable {
    ...
    /** full constructor */
    public TurqCurrentAmountTotal(int currentCardsId, java.math.BigDecimal transactionsTotalDept, java.math.BigDecimal transactionsTotalCredit, java.math.BigDecimal transactionsTotalAmountNow) {
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof TurqCurrentAmountTotal) ) return false;
