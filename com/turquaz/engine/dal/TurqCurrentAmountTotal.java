...
public class TurqCurrentAmountTotal implements Serializable
{
	/** identifier field */
	...
	/** full constructor */
	public TurqCurrentAmountTotal(int currentCardsId, java.math.BigDecimal transactionsTotalDept,
			java.math.BigDecimal transactionsTotalCredit, java.math.BigDecimal transactionsTotalAmountNow)
	{
	...
	{
		return new ToStringBuilder(this).append("currentCardsId", getCurrentCardsId()).append("transactionsTotalDept",
				getTransactionsTotalDept()).append("transactionsTotalCredit", getTransactionsTotalCredit()).append(
				"transactionsTotalAmountNow", getTransactionsTotalAmountNow()).toString();
	}

	public boolean equals(Object other)
	{
		if (!(other instanceof TurqCurrentAmountTotal))
			return false;
		TurqCurrentAmountTotal castOther = (TurqCurrentAmountTotal) other;
		return new EqualsBuilder().append(this.getCurrentCardsId(), castOther.getCurrentCardsId()).append(
				this.getTransactionsTotalDept(), castOther.getTransactionsTotalDept()).append(this.getTransactionsTotalCredit(),
				castOther.getTransactionsTotalCredit()).append(this.getTransactionsTotalAmountNow(),
				castOther.getTransactionsTotalAmountNow()).isEquals();
	}

	public int hashCode()
	{
		return new HashCodeBuilder().append(getCurrentCardsId()).append(getTransactionsTotalDept()).append(getTransactionsTotalCredit())
				.append(getTransactionsTotalAmountNow()).toHashCode();
	}
}