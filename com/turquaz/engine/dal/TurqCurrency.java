...
public class TurqCurrency implements Serializable
{
	...
	/** full constructor */
	public TurqCurrency(java.lang.String currenciesName, java.lang.String currenciesAbbreviation, java.lang.String currenciesCountry,
			java.lang.String createdBy, java.util.Date creationDate, java.lang.String updatedBy, java.util.Date lastModified,
			boolean defaultCurrency, Set turqInventoryPrices, Set turqTradebillTradebills, Set turqBanksCards, Set turqChequeCheques,
	...
	{
		if (!(other instanceof TurqCurrency))
			return false;
