...
public class TurqCurrentCardsPhone implements Serializable
{
	...
	/** full constructor */
	public TurqCurrentCardsPhone(int phonesCountryCode, int phonesCityCode, int phonesNumber, java.lang.String phonesType,
	...
	/** minimal constructor */
	public TurqCurrentCardsPhone(int phonesCountryCode, int phonesCityCode, int phonesNumber, java.lang.String phonesType,
			java.lang.String createdBy, java.lang.String updatedBy, java.util.Date lastModified,
			com.turquaz.engine.dal.TurqCurrentCard turqCurrentCard)
	{
		this.phonesCountryCode = phonesCountryCode;
		this.phonesCityCode = phonesCityCode;
	...
	{
		if (!(other instanceof TurqCurrentCardsPhone))
			return false;
