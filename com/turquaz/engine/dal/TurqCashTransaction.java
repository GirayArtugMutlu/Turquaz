...
public class TurqCashTransaction implements Serializable
{
	...
	/** full constructor */
	public TurqCashTransaction(java.util.Date transactionDate, java.lang.String transactionDefinition, java.lang.String documentNo,
			java.lang.String createdBy, java.util.Date creationDate, java.lang.String updatedBy, java.util.Date lastModified,
			com.turquaz.engine.dal.TurqCashTransactionType turqCashTransactionType,
			com.turquaz.engine.dal.TurqEngineSequence turqEngineSequence, Set turqCashTransactionRows)
	{
	...
	/** minimal constructor */
	public TurqCashTransaction(java.util.Date transactionDate, java.lang.String createdBy, java.util.Date creationDate,
	...
	{
		if (!(other instanceof TurqCashTransaction))
			return false;
