...
public class TurqOrderGroup implements Serializable
{
	...
	/** full constructor */
	public TurqOrderGroup(java.lang.String groupsName, java.lang.String groupsDescription, java.lang.String createdBy,
			java.util.Date creationDate, java.lang.String updatedBy, java.util.Date lastModified, Set turqOrderInGroups)
	{
	...
	{
		if (!(other instanceof TurqOrderGroup))
			return false;
