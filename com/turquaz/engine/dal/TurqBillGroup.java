...
public class TurqBillGroup implements Serializable
{
	...
	/** full constructor */
	public TurqBillGroup(java.lang.String groupsName, java.lang.String groupDescription, java.lang.String createdBy,
			java.util.Date creationDate, java.lang.String updatedBy, java.util.Date lastModified, Set turqBillInGroups)
	{
	...
	{
		if (!(other instanceof TurqBillGroup))
			return false;
