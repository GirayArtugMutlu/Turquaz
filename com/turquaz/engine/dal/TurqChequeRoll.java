...
public class TurqChequeRoll implements Serializable
{
	...
	/** full constructor */
	public TurqChequeRoll(java.util.Date chequeRollsDate, java.lang.String createdBy, java.util.Date creationDate,
			java.lang.String updatedBy, java.util.Date lastModified, java.lang.String chequeRollNo, boolean sumChequeAmounts,
			com.turquaz.engine.dal.TurqChequeRollAccountingAccount turqChequeRollAccountingAccount,
			com.turquaz.engine.dal.TurqChequeTransactionType turqChequeTransactionType,
			com.turquaz.engine.dal.TurqBanksCard turqBanksCard, com.turquaz.engine.dal.TurqEngineSequence turqEngineSequence,
			com.turquaz.engine.dal.TurqCurrentCard turqCurrentCard, Set turqChequeChequeInRolls)
	{
	...
	{
		if (!(other instanceof TurqChequeRoll))
			return false;
