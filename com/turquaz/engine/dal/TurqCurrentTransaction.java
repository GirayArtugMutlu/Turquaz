...
public class TurqCurrentTransaction implements Serializable
{
	...
	/** full constructor */
	public TurqCurrentTransaction(java.util.Date transactionsDate, java.lang.String transactionsDocumentNo,
			java.math.BigDecimal transactionsTotalCredit, java.math.BigDecimal transactionsTotalDiscount,
			java.math.BigDecimal transactionsTotalDept, java.lang.String createdBy, java.util.Date creationDate,
			java.lang.String updatedBy, java.util.Date lastModified, java.lang.String transactionsDefinition,
			java.math.BigDecimal totalCreditInForeignCurrency, java.math.BigDecimal totalDeptInForeignCurrency,
			java.math.BigDecimal totalDiscountInForeignCurrency,
			com.turquaz.engine.dal.TurqCurrencyExchangeRate turqCurrencyExchangeRate,
			com.turquaz.engine.dal.TurqCurrentTransactionType turqCurrentTransactionType,
			com.turquaz.engine.dal.TurqEngineSequence turqEngineSequence, com.turquaz.engine.dal.TurqCurrentCard turqCurrentCard,
			Set turqCurrentTransactionBillsByCurrentTransactionsIdOpen, Set turqCurrentTransactionBillsByCurrentTransactionsIdClose)
	{
	...
	public void setTurqCurrentTransactionBillsByCurrentTransactionsIdOpen(
			java.util.Set turqCurrentTransactionBillsByCurrentTransactionsIdOpen)
	{
		this.turqCurrentTransactionBillsByCurrentTransactionsIdOpen = turqCurrentTransactionBillsByCurrentTransactionsIdOpen;
	}
	...
	public void setTurqCurrentTransactionBillsByCurrentTransactionsIdClose(
			java.util.Set turqCurrentTransactionBillsByCurrentTransactionsIdClose)
	{
		this.turqCurrentTransactionBillsByCurrentTransactionsIdClose = turqCurrentTransactionBillsByCurrentTransactionsIdClose;
	}
	...
	{
		if (!(other instanceof TurqCurrentTransaction))
			return false;
