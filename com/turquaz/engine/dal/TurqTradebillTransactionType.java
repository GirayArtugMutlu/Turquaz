...
public class TurqTradebillTransactionType implements Serializable
{
	...
	/** full constructor */
	public TurqTradebillTransactionType(java.lang.String transactionTypesName, short transactionTypesParent, java.util.Date createdBy,
			java.util.Date creationDate, java.lang.String updatedBy, java.util.Date lastModified,
			com.turquaz.engine.dal.TurqAccountingAccount turqAccountingAccount, Set turqTradebillRolls)
	{
	...
	{
		if (!(other instanceof TurqTradebillTransactionType))
			return false;
