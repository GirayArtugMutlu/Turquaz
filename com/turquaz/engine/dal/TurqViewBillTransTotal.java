...
public class TurqViewBillTransTotal implements Serializable {
    ...
    /** full constructor */
    public TurqViewBillTransTotal(int billsId, java.math.BigDecimal totalprice, java.math.BigDecimal vatamount, java.math.BigDecimal specialvatamount, java.math.BigDecimal discountamount) {
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof TurqViewBillTransTotal) ) return false;
