...
public class TurqBanksTransaction implements Serializable
{
	...
	/** full constructor */
	public TurqBanksTransaction(java.math.BigDecimal deptAmount, java.lang.String createdBy, java.util.Date creationDate,
			java.lang.String updatedBy, java.util.Date lastModified, java.math.BigDecimal creditAmount,
	...
	{
		if (!(other instanceof TurqBanksTransaction))
			return false;
