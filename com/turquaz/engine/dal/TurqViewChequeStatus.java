...
public class TurqViewChequeStatus implements Serializable {
    ...
    public String toString() {
        return new ToStringBuilder(this)
            ...
            .append("chequesPortfolioNo", getChequesPortfolioNo())
            .append("chequesNo", getChequesNo())
            .append("banksId", getBanksId())
            .append("chequesDueDate", getChequesDueDate())
            .append("chequesDebtor", getChequesDebtor())
            .append("chequesPaymentPlace", getChequesPaymentPlace())
            .append("chequesValueDate", getChequesValueDate())
            .append("chequesAmount", getChequesAmount())
            ...
            .append("chequeRollNo", getChequeRollNo())
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof TurqViewChequeStatus) ) return false;
        TurqViewChequeStatus castOther = (TurqViewChequeStatus) other;
        return new EqualsBuilder()
            .append(this.getChequeChequesId(), castOther.getChequeChequesId())
            .append(this.getChequesPortfolioNo(), castOther.getChequesPortfolioNo())
            .append(this.getChequesNo(), castOther.getChequesNo())
            .append(this.getBanksId(), castOther.getBanksId())
            .append(this.getChequesDueDate(), castOther.getChequesDueDate())
            .append(this.getChequesDebtor(), castOther.getChequesDebtor())
            .append(this.getChequesPaymentPlace(), castOther.getChequesPaymentPlace())
            .append(this.getChequesValueDate(), castOther.getChequesValueDate())
            .append(this.getChequesAmount(), castOther.getChequesAmount())
            ...
            .append(this.getChequeRollNo(), castOther.getChequeRollNo())
    ...
    public int hashCode() {
        return new HashCodeBuilder()
            ...
            .append(getChequesPortfolioNo())
            .append(getChequesNo())
            .append(getBanksId())
            .append(getChequesDueDate())
            .append(getChequesDebtor())
            .append(getChequesPaymentPlace())
            .append(getChequesValueDate())
            .append(getChequesAmount())
