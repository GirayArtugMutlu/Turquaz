...
public class TurqCurrencyExchangeRate implements Serializable
{
	...
	public TurqCurrencyExchangeRate(java.util.Date exhangeRatesDate, java.math.BigDecimal exchangeRatio,
			...
			Set turqAccountingTransactionColumns, Set turqChequeCheques, Set turqCurrentTransactions, Set turqBillConsignmentCommons,
			Set turqCashTransactionRows, Set turqBanksTransactions)
	{
