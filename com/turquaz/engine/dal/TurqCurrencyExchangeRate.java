...
public class TurqCurrencyExchangeRate implements Serializable
{
	...
	/** full constructor */
	public TurqCurrencyExchangeRate(java.util.Date exhangeRatesDate, java.math.BigDecimal exchangeRatio,
			com.turquaz.engine.dal.TurqCurrency turqCurrencyByBaseCurrencyId,
			com.turquaz.engine.dal.TurqCurrency turqCurrencyByExchangeCurrencyId, Set turqAccountingTransactions,
			Set turqAccountingTransactionColumns, Set turqInventoryTransactions, Set turqChequeCheques, Set turqConsignments,
			Set turqCurrentTransactions, Set turqCashTransactionRows, Set turqBanksTransactions, Set turqBills)
	{
	...
	{
		if (!(other instanceof TurqCurrencyExchangeRate))
			return false;
