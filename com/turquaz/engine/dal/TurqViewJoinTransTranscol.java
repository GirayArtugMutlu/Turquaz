...
public class TurqViewJoinTransTranscol implements Serializable {
    ...
    /** full constructor */
    public TurqViewJoinTransTranscol(java.math.BigDecimal deptAmount, java.math.BigDecimal creditAmount, int accountingAccountsId, int accountingTransactionColumnsId, int accountingTransactionsId, int accountingJournalId, int accountingTransactionTypesId, java.util.Date transactionsDate, int moduleId, java.lang.String transactionDocumentNo, int engineSequencesId, java.lang.String transactionDescription, java.lang.String createdBy, java.util.Date creationDate, java.lang.String updatedBy, java.util.Date lastModified) {
    ...
    public String toString() {
        return new ToStringBuilder(this)
            .append("deptAmount", getDeptAmount())
            ...
            .append("transactionsDate", getTransactionsDate())
            .append("moduleId", getModuleId())
            .append("transactionDocumentNo", getTransactionDocumentNo())
            .append("engineSequencesId", getEngineSequencesId())
            .append("transactionDescription", getTransactionDescription())
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof TurqViewJoinTransTranscol) ) return false;
        TurqViewJoinTransTranscol castOther = (TurqViewJoinTransTranscol) other;
        return new EqualsBuilder()
            .append(this.getDeptAmount(), castOther.getDeptAmount())
            .append(this.getCreditAmount(), castOther.getCreditAmount())
            ...
            .append(this.getTransactionsDate(), castOther.getTransactionsDate())
            .append(this.getModuleId(), castOther.getModuleId())
            .append(this.getTransactionDocumentNo(), castOther.getTransactionDocumentNo())
            .append(this.getEngineSequencesId(), castOther.getEngineSequencesId())
            .append(this.getTransactionDescription(), castOther.getTransactionDescription())
            .append(this.getCreatedBy(), castOther.getCreatedBy())
            .append(this.getCreationDate(), castOther.getCreationDate())
            .append(this.getUpdatedBy(), castOther.getUpdatedBy())
            .append(this.getLastModified(), castOther.getLastModified())
            .isEquals();
    }

    public int hashCode() {
        return new HashCodeBuilder()
            .append(getDeptAmount())
            ...
            .append(getTransactionsDate())
            .append(getModuleId())
            .append(getTransactionDocumentNo())
            .append(getEngineSequencesId())
            .append(getTransactionDescription())
            .append(getCreatedBy())
