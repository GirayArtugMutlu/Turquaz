...
public class TurqInventoryAmountTotal implements Serializable {
    ...
    /** full constructor */
    public TurqInventoryAmountTotal(int inventoryCardsId, java.math.BigDecimal transactionsAmountIn, java.math.BigDecimal transactionsTotalAmountOut, java.math.BigDecimal transactionsTotalAmountNow) {
    ...
    /** default constructor */
    public TurqInventoryAmountTotal() {
    }
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof TurqInventoryAmountTotal) ) return false;
        TurqInventoryAmountTotal castOther = (TurqInventoryAmountTotal) other;
