...
public class TurqAccountingJournal implements Serializable
{
	...
	/** full constructor */
	public TurqAccountingJournal(java.util.Date journalDate, java.lang.String createdBy, java.util.Date creationDate,
	...
	{
		if (!(other instanceof TurqAccountingJournal))
			return false;
