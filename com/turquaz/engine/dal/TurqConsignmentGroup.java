...
public class TurqConsignmentGroup implements Serializable
{
	...
	/** full constructor */
	public TurqConsignmentGroup(java.lang.String groupsName, java.lang.String groupsDescription, java.lang.String createdBy,
			java.util.Date creationDate, java.lang.String updatedBy, java.util.Date lastModified, Set turqConsignmentsInGroups)
	{
	...
	{
		if (!(other instanceof TurqConsignmentGroup))
			return false;
