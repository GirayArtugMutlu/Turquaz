...
public class TurqViewInvPriceTotal implements Serializable {
    ...
    /** full constructor */
    public TurqViewInvPriceTotal(int engineSequencesId, java.math.BigDecimal totalprice, java.math.BigDecimal vatamount, java.math.BigDecimal specialvatamount, java.math.BigDecimal discountamount) {
    ...
    public String toString() {
        return new ToStringBuilder(this)
            ...
            .append("specialvatamount", getSpecialvatamount())
            .append("discountamount", getDiscountamount())
            .toString();
    }

    public boolean equals(Object other) {
        if ( !(other instanceof TurqViewInvPriceTotal) ) return false;
        ...
        return new EqualsBuilder()
            ...
            .append(this.getTotalprice(), castOther.getTotalprice())
            .append(this.getVatamount(), castOther.getVatamount())
            .append(this.getSpecialvatamount(), castOther.getSpecialvatamount())
            .append(this.getDiscountamount(), castOther.getDiscountamount())
            .isEquals();
    }
