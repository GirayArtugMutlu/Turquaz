...
public class TurqViewAccTransTotalAmount implements Serializable {
    ...
    /** full constructor */
    public TurqViewAccTransTotalAmount(int accountingTransactionsId, java.math.BigDecimal totalcreditamount, java.math.BigDecimal totaldeptamount) {
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof TurqViewAccTransTotalAmount) ) return false;
