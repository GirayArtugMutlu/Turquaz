...
public class TurqViewInventoryTotal implements Serializable
{
	...
	/** full constructor */
	public TurqViewInventoryTotal(int inventoryCardsId, java.math.BigDecimal totalAmountIn, java.math.BigDecimal totalPriceIn,
			java.math.BigDecimal totalAmountOut, java.math.BigDecimal totalPriceOut, java.math.BigDecimal totalTransoverAmountIn,
			java.math.BigDecimal totalTransoverPriceIn, java.math.BigDecimal totalTransoverAmountOut,
			java.math.BigDecimal totalTransoverPriceOut)
	{
	...
	{
		return new ToStringBuilder(this).append("inventoryCardsId", getInventoryCardsId()).append("totalAmountIn", getTotalAmountIn())
				.append("totalPriceIn", getTotalPriceIn()).append("totalAmountOut", getTotalAmountOut()).append("totalPriceOut",
						getTotalPriceOut()).append("totalTransoverAmountIn", getTotalTransoverAmountIn()).append(
						"totalTransoverPriceIn", getTotalTransoverPriceIn()).append("totalTransoverAmountOut",
						getTotalTransoverAmountOut()).append("totalTransoverPriceOut", getTotalTransoverPriceOut()).toString();
	}

	public boolean equals(Object other)
	{
		if (!(other instanceof TurqViewInventoryTotal))
			return false;
		TurqViewInventoryTotal castOther = (TurqViewInventoryTotal) other;
		return new EqualsBuilder().append(this.getInventoryCardsId(), castOther.getInventoryCardsId()).append(this.getTotalAmountIn(),
				castOther.getTotalAmountIn()).append(this.getTotalPriceIn(), castOther.getTotalPriceIn()).append(
				this.getTotalAmountOut(), castOther.getTotalAmountOut()).append(this.getTotalPriceOut(), castOther.getTotalPriceOut())
				.append(this.getTotalTransoverAmountIn(), castOther.getTotalTransoverAmountIn()).append(
						this.getTotalTransoverPriceIn(), castOther.getTotalTransoverPriceIn()).append(
						this.getTotalTransoverAmountOut(), castOther.getTotalTransoverAmountOut()).append(
						this.getTotalTransoverPriceOut(), castOther.getTotalTransoverPriceOut()).isEquals();
	}

	public int hashCode()
	{
		return new HashCodeBuilder().append(getInventoryCardsId()).append(getTotalAmountIn()).append(getTotalPriceIn()).append(
				getTotalAmountOut()).append(getTotalPriceOut()).append(getTotalTransoverAmountIn()).append(getTotalTransoverPriceIn())
				.append(getTotalTransoverAmountOut()).append(getTotalTransoverPriceOut()).toHashCode();
	}
}