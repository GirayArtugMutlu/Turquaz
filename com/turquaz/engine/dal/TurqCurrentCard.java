...
public class TurqCurrentCard implements Serializable
{
	...
	/** full constructor */
	public TurqCurrentCard(java.lang.String cardsCurrentCode, java.lang.String cardsName, java.lang.String cardsDefinition,
			java.lang.String cardsAddress, java.math.BigDecimal cardsDiscountRate, java.math.BigDecimal cardsDiscountPayment,
			java.math.BigDecimal cardsCreditLimit, java.math.BigDecimal cardsRiskLimit, java.lang.String cardsTaxDepartment,
			java.lang.String cardsTaxNumber, java.lang.String createdBy, java.util.Date creationDate, java.lang.String updatedBy,
			java.util.Date lastModified, int daysToValue, Set turqChequeRolls, Set turqCurrentContacts, Set turqOrders,
			Set turqCurrentTransactions, Set turqBillConsignmentCommons, Set turqTradebillRolls, Set turqCurrentCardsGroups,
			Set turqCurrentAccountingAccounts, Set turqCurrentCardsPhones)
	{
	...
	public TurqCurrentCard(java.lang.String cardsCurrentCode, java.lang.String cardsName, java.lang.String cardsDefinition,
			...
			java.math.BigDecimal cardsCreditLimit, java.math.BigDecimal cardsRiskLimit, java.lang.String cardsTaxDepartment,
			java.lang.String cardsTaxNumber, java.lang.String createdBy, java.util.Date creationDate, java.lang.String updatedBy,
			java.util.Date lastModified, Set turqChequeRolls, Set turqCurrentContacts, Set turqOrders, Set turqCurrentTransactions,
			Set turqBillConsignmentCommons, Set turqTradebillRolls, Set turqCurrentCardsGroups, Set turqCurrentAccountingAccounts,
			Set turqCurrentCardsPhones)
	{
		this.cardsCurrentCode = cardsCurrentCode;
		this.cardsName = cardsName;
		this.cardsDefinition = cardsDefinition;
	...
	{
		if (!(other instanceof TurqCurrentCard))
			return false;
