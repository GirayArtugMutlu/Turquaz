...
public class TurqBillConsignmentCommon implements Serializable
{
	...
	/** full constructor */
	public TurqBillConsignmentCommon(java.math.BigDecimal discountAmount, java.math.BigDecimal vatAmount, java.math.BigDecimal charges,
			java.math.BigDecimal totalAmount, java.math.BigDecimal specialVatAmount, java.lang.String billDocumentNo,
			java.lang.String consignmentDocumentNo, java.lang.String createdBy, java.util.Date creationDate, java.lang.String updatedBy,
			java.util.Date lastModified, int discountRate, java.math.BigDecimal discountAmountInForeignCurrency,
			java.math.BigDecimal vatAmountInForeignCurrency, java.math.BigDecimal chargesInForeignCurrency,
			java.math.BigDecimal totalAmountInForeignCurrency, java.math.BigDecimal specialVatAmountInForeignCurrency,
			com.turquaz.engine.dal.TurqCurrencyExchangeRate turqCurrencyExchangeRate,
			com.turquaz.engine.dal.TurqCurrentCard turqCurrentCard, Set turqConsignments, Set turqBills)
	{
	...
	{
		if (!(other instanceof TurqBillConsignmentCommon))
			return false;
