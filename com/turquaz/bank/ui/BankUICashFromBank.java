	...
	private void initGUI()
	{
		try
		{
			...
			}
			{
				...
				lblAmount.setText(Messages.getString("BankUICashFromBank.4")); //$NON-NLS-1$
			}
			{
		...
		try
		{
			if (verifyFields())
			{
				BankBLTransactionAdd.saveCashTransaction(txtBankCard.getTurqBank(), currentPicker.getTurqCashCard(),
						EngBLCommon.BANK_TRANS_CASH_DRAW, null, curAmount.getBigDecimalValue(), datePick.getDate(), txtDefinition
