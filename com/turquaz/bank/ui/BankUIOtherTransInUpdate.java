...
* *************************************
*/
public class BankUIOtherTransInUpdate extends org.eclipse.swt.widgets.Dialog {
	...
	public BankUIOtherTransInUpdate(Shell parent, int style, TurqBanksTransactionBill transBill) {
		super(parent, style);
	...
	public void update(){
	    try{
	        ...
	        BankBLTransactionUpdate.updateOtherTransactionBill(transBill,compCashTrans.getTxtBankCard().getTurqBank(),
	                									  compCashTrans.getCurrentPicker().getTurqAccountingAccount(),
