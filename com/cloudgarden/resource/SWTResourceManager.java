...
/**
 * Class to manage SWT resources (Font, Color, Image and Cursor) There are no restrictions on the use of this code. You may change this code
 * and your changes will not be overwritten, but if you change the version number below then this class will be completely overwritten by
 * Jigloo. #SWTResourceManager:version3.0.0#
 */
public class SWTResourceManager
{
	...
	/**
	 * This method should be called by *all* Widgets which use resources provided by this SWTResourceManager. When widgets are disposed,
	 * they are removed from the "users" Vector, and when no more registered Widgets are left, all resources are disposed.
	 * <P>
	 * If this method is not called for all Widgets then it should not be called at all, and the "dispose" method should be explicitly
	 * called after all resources are no longer being used.
	 */
