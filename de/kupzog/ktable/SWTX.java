...
public class SWTX {
	...
	//private static LRUMap m_StringExtentCache = new LRUMap();
	...
	public static int drawTextVerticalAlign(GC gc, String text, int textAlign, int x, int y, int w, int h) {
		...
		throw new SWTException(
			"SWTX de hata " + (textAlign & ALIGN_VERTICAL_MASK));
	}
	...
	public static void drawImageVerticalAlign(GC gc, Image image, int imageAlign, int x, int y, int h) {
		...
		throw new SWTException(
			"Hеизвестный тип выравнивания изображения по вертикали: " + (imageAlign & ALIGN_VERTICAL_MASK));
	}
	public static void drawTextImage(
		...
		try {
			...
			if ((textAlign & ALIGN_HORIZONTAL_MASK) == ALIGN_HORIZONTAL_LEFT) {
				...
				throw new SWTException(
					"Hеизвестный тип выравнивания изображения по горизонтали: " + (imageAlign & ALIGN_HORIZONTAL_MASK));
			} // text align left
			...
			throw new SWTException(
				"Hеизвестный тип выравнивания текста по горизонтали: " + (textAlign & ALIGN_HORIZONTAL_MASK));
		} // trye
		finally {
