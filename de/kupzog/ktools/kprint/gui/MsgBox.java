...
public class MsgBox {
	...
	/**
	 * Erlaubt das Hinzufügen weiterer Steuerelemente
	 * zur MsgBox. Diese werden unter dem Text und über
	 * der Buttonleiste engezeigt.
	 * 
	 * Benutzung:
	 * MsgBox box = new MsgBox(display,"Box","Beispiel","OK");
	 * Text feld = new Text(box.getShell(),SWT.BORDER);
	 * box.addControl(feld);
	 * box.open();
	 * (hier Zugriff auf feld)
	 * box.dispose();
	 * 
	 * @param c
