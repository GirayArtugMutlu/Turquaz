...
public class ButtonBar extends Composite
{
    ...
    /** Fügt einen Button zur Leiste hinzu. 
     *  Gibt eine Referenz auf den angelegten Button zurück.*/
    public Button addButton(String name, String toolTip, SelectionListener selListener)
    {
        ...
        if (selListener != null) b.addSelectionListener(selListener);
        myButtons.add(b);
        return b;
    }

    
    /** Fügt einen Button zur Leiste hinzu, und registriert ihn 
     * bei der in myShell übergebenen Shell als DefaultButton.   */
