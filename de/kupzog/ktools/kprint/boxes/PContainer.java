...
public class PContainer
{
	...
	/**
	 * Returns the height of this Container on the first pages it occupies. Usually only used with headers and footers. Does only work if
	 * the container is already layouted.
	 * 
	 * @return int
	 */
	...
	/*
	 * Gibt true zurück, wenn ein Seitenumbruch nötig ist. Wird in diesem Falle von layout() nochmal für die gleiche Zeile aber die nächste
	 * Seite aufgerufen.
	 */
