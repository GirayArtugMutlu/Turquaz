...
public class PImageBox extends PBox {
	...
	/**
	 * Sets the Image. The size of the image will be calculated
	 * by using the dpi parameter, in which you can specify which
	 * resolution is the "native" image resulotion.
	 * If you e.g. specify 600 dpi and print on a 600 dpi printer,
	 * the image will not be resized. If you print it on an 300 dpi
	...
	public int layoutHowMuchWouldYouOccupyOf(Point spaceLeft, int page) {
		...
		if (imgTargetSize.y > spaceLeft.y) return -1;
