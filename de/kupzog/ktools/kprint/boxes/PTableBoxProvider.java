...
/**
 * Used by PTable to print KTables. Comparable to KTableCellRenderer. Creates a PBox for a Table cell. It gets width and height information
 * from the table which are pixel values fro screen view. It may use these values as a guideline.
 * 
 * @author Friederich Kupzog
 */
public class PTableBoxProvider
{
	public PBox createBox(PContainer parent, int style, int col, int row, int widthFromModel, int heightFromModel, boolean fixed,
			Object content)
	{
		// create a text box
